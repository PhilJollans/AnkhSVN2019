...
namespace Ankh.Services
{
    partial class AnkhDiff
    {
        ...
        IList<AnkhDiffTool> GetDiffToolTemplates()
        {
            ...
            tools.Add(new DiffTool(this, "ECMerge", "Elli頃omputing Merge",
                RegistrySearch("SOFTWARE\\ElliéComputing\\Merge", "Path")
                    ?? "$(ProgramFiles)\\ElliéComputing\\Merge\\guimerge.exe",
        ...
        IList<AnkhDiffTool> GetMergeToolTemplates()
        {
            ...
            tools.Add(new DiffTool(this, "ECMerge", "ElliéComputing Merge",
                RegistrySearch("SOFTWARE\\ElliéComputing\\Merge", "Path")
                    ?? "$(ProgramFiles)\\ElliéComputing\\Merge\\guimerge.exe",
